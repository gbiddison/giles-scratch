...
class Neuron(PickleToXML):
    ...
    TimeConstant = 1.0 / 60.0 # Seconds per simulated time step
    ICType_VInf = 0
    ICType_Random = 1
    ICType_None = 2
    ...
    def changeState(self):
        if self._nextFiringFrequency != self._firingFrequency:
